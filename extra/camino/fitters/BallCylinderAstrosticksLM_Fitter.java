 ...
 * <dt>Purpose:
 * 
 * <dd>Fits the ballcylinderastrosticks model using one run of a Levenburg
 ...
 * optimizing cos^{-1} sqrt(f). The radius is constrained to 0.1-20 microns by
 * optimizing cos^{-1} sqrt(R-1e-7/20e-6).
 * 
 * </dl>
 * 
 ...
 * 
 */
public class BallCylinderAstrosticksLM_Fitter extends CompartmentFitter {
	 ...
	 */
	public BallCylinderAstrosticksLM_Fitter() {
	}
	 ...
	 */
	public BallCylinderAstrosticksLM_Fitter(DW_Scheme scheme) {
	...
	protected void makeCodec() {
		cod = new Codec() {
			...
			public double[] optToModel(double[] optParams) {
				...
				modelParams[3] = 1 - f - ballf; // volume fraction third compartment volume
	...
	public static void main(String[] args) {
		...
		BallCylinderAstrosticksLM_Fitter inv = new BallCylinderAstrosticksLM_Fitter(
