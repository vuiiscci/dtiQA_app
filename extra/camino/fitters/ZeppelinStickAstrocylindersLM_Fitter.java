 ...
 * <dt>Purpose:
 * 
 * <dd>Fits the zeppelinstick and astrocylinders model using one run of a
 ...
 * 
 */
public class ZeppelinStickAstrocylindersLM_Fitter extends CompartmentFitter {
	 ...
	 */
	public ZeppelinStickAstrocylindersLM_Fitter() {
	}
	 ...
	 */
	public ZeppelinStickAstrocylindersLM_Fitter(DW_Scheme scheme) {
		...
		cod = new Codec() {
			...
			public double[] modelToOpt(double[] modelParams) {
				...
				optParams[7] = (Math.acos(Math
						.sqrt((modelParams[12] - 1e-7) / 20e-6)));// R
			...
			public double[] optToModel(double[] optParams) {
				...
				modelParams[12] = 1e-7 + (Math.cos(optParams[7])
						* Math.cos(optParams[7]) * 20e-6);// R constraining
															// the radius
	...
	public static void main(String[] args) {
		...
		ZeppelinStickAstrocylindersLM_Fitter inv = new ZeppelinStickAstrocylindersLM_Fitter(
