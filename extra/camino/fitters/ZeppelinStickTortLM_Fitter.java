 ...
 * <dt>Purpose:
 * 
 * <dd>Fits the zeppelin and stick model predicting zeppelin
 ...
 * compartment.  Perpendicular diffusivity is (1-f) time the
 * parallel one. Diffusivity and unweighted signal are constrained
 ...
 *
 */
public class ZeppelinStickTortLM_Fitter extends CompartmentFitter {
	 ...
	 */
	public ZeppelinStickTortLM_Fitter() {
	}
	 ...
	 */
	public ZeppelinStickTortLM_Fitter(DW_Scheme scheme) {
	 ...
	 */
	public ZeppelinStickTortLM_Fitter(DW_Scheme scheme, String[] compNames,
		...
		cod = new Codec() {
			...
			public double[] optToModel(double[] optParams) {
				...
				modelParams[5] = optParams[4]; //phi
                                ...
                                modelParams[9] = modelParams[2]*modelParams[3];// diff perp zep
                ...
                public RealMatrix getJacobian(double[] optParams) {
                    ...
                    J.entries[7][3] = 1.0;
                    J.entries[8][4] = 1.0;
		    J.entries[9][1] = J.entries[2][1]*optParams[2]*optParams[2];
		    double stickf = Math.cos(optParams[1]); //volume fraction of stick compartment;                                                                    
		    J.entries[9][2] = stickf*stickf*J.entries[3][2];
	...
	protected double[] getStartPoint(double[] data) {
		...
		modelParams[7] = theta;
		modelParams[8] = phi;
		modelParams[9] = modelParams[2]*modelParams[3];
	...
	public static void main(String[] args) {
		...
		ZeppelinStickLM_DirectFitter inv = new ZeppelinStickLM_DirectFitter(CL_Initializer.imPars);
