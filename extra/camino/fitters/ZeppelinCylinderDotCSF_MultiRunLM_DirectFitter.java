 ...
 * <dt>Purpose:
 * 
 * <dd>Fits the zeppelin-cylinder-dot-CSF model using multiple runs of
 * a Levenburg Marquardt and a specified noise model.
 * 
 * <dt>Description:
 * 
 * <dd> Fitting is as in ZeppelinCylinderDotCSF_LM_DirectFitter.  The
 ...
 *
 */
public class ZeppelinCylinderDotCSF_MultiRunLM_DirectFitter extends ZeppelinCylinderDotCSF_LM_DirectFitter {
     ...
     */
    public ZeppelinCylinderDotCSF_MultiRunLM_DirectFitter(DW_Scheme scheme, int repeats, int seed) {
	
	this.scheme = scheme;
	makeCodec();
	String[] compNames = new String[4];
	compNames[0] = new String("cylindergpd");
	compNames[1] = new String("zeppelin");
	compNames[2] = new String("dot");
	compNames[3] = new String("ball");
    ...
    public static void main(String[] args) {
        ...
        ZeppelinCylinderDotCSF_MultiRunLM_DirectFitter inv = new ZeppelinCylinderDotCSF_MultiRunLM_DirectFitter(CL_Initializer.imPars, 3, 0);
