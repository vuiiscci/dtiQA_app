 ...
 * <dt>Purpose:
 * 
 * <dd>Fits the zeppelincylinderastrosticks model using one run of a Levenburg
 * Marquardt.
 * 
 * <dt>Description:
 * 
 ...
 *
 */
public class ZeppelinCylinderAstrosticksLM_Fitter extends CompartmentFitter {
	 ...
	 */
	public ZeppelinCylinderAstrosticksLM_Fitter(DW_Scheme scheme) {
	...
	public static void main(String[] args) {
		...
		ZeppelinCylinderAstrosticksLM_Fitter inv = new ZeppelinCylinderAstrosticksLM_Fitter(
