 ...
 * <dt>Purpose:
 * 
 * <dd>Fits the tensorcylinderdot model using one run of a Levenburg
 * Marquardt.
 * 
 * <dt>Description:
 * 
 ...
 *
 */
public class TensorCylinderDotLM_Fitter extends CompartmentFitter {
	 ...
	 */
	public TensorCylinderDotLM_Fitter() {
	}
	 ...
	 */
	public TensorCylinderDotLM_Fitter(DW_Scheme scheme) {
	...
	public static void main(String[] args) {
		...
		TensorCylinderDotLM_Fitter inv = new TensorCylinderDotLM_Fitter(
