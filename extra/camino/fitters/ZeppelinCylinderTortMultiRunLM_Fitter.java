 ...
 * <dt>Purpose:
 * 
 * <dd>Fits the zeppelin and cylinder model with tortuosity approximation
 * using multiple runs of a Levenburg
 * Marquardt and a specified noise model.
 * 
 * <dt>Description:
 * 
 * <dd> Fitting is as in ZeppelinCylinderTortLM_Fitter.  The
 ...
 *
 */
public class ZeppelinCylinderTortMultiRunLM_Fitter extends ZeppelinCylinderTortLM_Fitter {
     ...
     */
    public ZeppelinCylinderTortMultiRunLM_Fitter(DW_Scheme scheme, int repeats, int seed) {
    ...
    public static void main(String[] args) {
        ...
        ZeppelinCylinderTortMultiRunLM_Fitter inv = new ZeppelinCylinderTortMultiRunLM_Fitter(CL_Initializer.imPars, 3, 0);
