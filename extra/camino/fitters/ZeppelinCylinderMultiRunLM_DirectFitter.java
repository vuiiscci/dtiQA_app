 ...
 * <dt>Purpose:
 * 
 * <dd>Fits the zeppelin and cylinder model using multiple runs of a Levenburg
 * Marquardt and a specified noise model.
 * 
 * <dt>Description:
 * 
 * <dd> Fitting is as in ZeppelinCylinderLM_DirectFitter.  The
 ...
 *
 */
public class ZeppelinCylinderMultiRunLM_DirectFitter extends ZeppelinCylinderLM_DirectFitter {
     ...
     */
    public ZeppelinCylinderMultiRunLM_DirectFitter(DW_Scheme scheme, int repeats, int seed) {
    ...
    public static void main(String[] args) {
        ...
        ZeppelinCylinderMultiRunLM_DirectFitter inv = new ZeppelinCylinderMultiRunLM_DirectFitter(CL_Initializer.imPars, 3, 0);
