 ...
 * <dt>Purpose:
 * 
 * <dd>Fits the ballstickastrosticks model using multiple runs of a Levenburg
 * Marquardt.
 * 
 * <dt>Description:
 * 
 * <dd> Fitting is as in BallStickAstrosticksLM_GaussianFitter.  The
 ...
 *
 */
public class BallStickAstrosticksMultiRunLM_Fitter extends
	 ...
	 */
	public BallStickAstrosticksMultiRunLM_Fitter(DW_Scheme scheme,
		...
		initialParams[8] = 1.7E-9;//astrosticks diffusivity
	...
	public static void main(String[] args) {
		...
		BallStickAstrosticksMultiRunLM_Fitter inv = new BallStickAstrosticksMultiRunLM_Fitter(
