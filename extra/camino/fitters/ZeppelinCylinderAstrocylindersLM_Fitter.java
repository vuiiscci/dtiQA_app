 ...
 * <dt>Purpose:
 * 
 * <dd>Fits the zeppelincylinderastrocylinders model using one run of a
 * Levenburg Marquardt.
 * 
 * <dt>Description:
 * 
 ...
 * 
 */
public class ZeppelinCylinderAstrocylindersLM_Fitter extends CompartmentFitter {
	 ...
	 */
	public ZeppelinCylinderAstrocylindersLM_Fitter() {
	}
	 ...
	 */
	public ZeppelinCylinderAstrocylindersLM_Fitter(DW_Scheme scheme) {
	...
	public static void main(String[] args) {
		...
		ZeppelinCylinderAstrocylindersLM_Fitter inv = new ZeppelinCylinderAstrocylindersLM_Fitter(
