 ...
 * <dt>Purpose:
 * 
 * <dd>Fits the ballstickdot model using multiple runs of a Levenburg
 * Marquardt.
 * 
 * <dt>Description:
 * 
 * <dd> Fitting is as in BallStickDotLM_GaussianFitter.  The
 ...
 *
 */
public class BallStickDotMultiRunLM_Fitter extends
	 ...
	 */
	public BallStickDotMultiRunLM_Fitter(DW_Scheme scheme, int repeats,
			int seed) {
	...
	public static void main(String[] args) {
		...
		BallStickDotMultiRunLM_Fitter inv = new BallStickDotMultiRunLM_Fitter(
