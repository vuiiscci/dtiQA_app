 ...
 * <dt>Purpose:
 * 
 * <dd>Fits the tensorstick and astrocylinders model using one run of a Levenburg
 * Marquard.
 * 
 * <dt>Description:
 * 
 ...
 *
 */
public class TensorStickAstrocylindersLM_Fitter extends CompartmentFitter {
	 ...
	 */
	public TensorStickAstrocylindersLM_Fitter() {
	}
	 ...
	 */
	public TensorStickAstrocylindersLM_Fitter(DW_Scheme scheme) {
		...
		cod = new Codec() {
			...
			public double[] modelToOpt(double[] modelParams) {
				...
				optParams[9] =(Math.acos(Math
						.sqrt((modelParams[14] - 1e-7) / 20e-6)));// R//R constraining the radius from 0-20 microns
				return optParams;
			}
			...
			public double[] optToModel(double[] optParams) {
				...
				modelParams[14] = 1e-7 + (Math.cos(optParams[9])
						* Math.cos(optParams[9]) * 20e-6);// R constraining
	...
	public static void main(String[] args) {
		...
		TensorStickAstrocylindersLM_Fitter inv = new TensorStickAstrocylindersLM_Fitter(
