 ...
 * <dt>Purpose:
 * 
 * <dd>Fits the ballcylinderastrocylinders model using one run of a Levenburg
 * Marquardt.
 * 
 * <dt>Description:
 * 
 ...
 * radius is constrained to 0.1-20 microns by optimizing cos^{-1}
 * sqrt(R-1e-7/20e-6).
 * </dl>
 * 
 ...
 * 
 */
public class BallCylinderAstrocylindersLM_Fitter extends CompartmentFitter {
	 ...
	 */
	public BallCylinderAstrocylindersLM_Fitter() {
	}
	 ...
	 */
	public BallCylinderAstrocylindersLM_Fitter(DW_Scheme scheme) {
	...
	protected void makeCodec() {
		cod = new Codec() {
			...
			public double[] optToModel(double[] optParams) {
				...
				modelParams[10] = modelParams[7]; // R
	...
	public static void main(String[] args) {
		...
		BallCylinderAstrocylindersLM_Fitter inv = new BallCylinderAstrocylindersLM_Fitter(
