 ...
 * <dt>Purpose:
 * 
 * <dd>Fits the biexponential model using multiple runs of a Levenburg
 * Marquardt.
 * 
 * <dt>Description:
 * 
 * <dd> Fitting is as in BiZeppelinLM_Fitter.  The
 ...
 *
 */
public class BiZeppelinMultiRunLM_Fitter extends
		BiZeppelinLM_Fitter {
	 ...
	 */
	public BiZeppelinMultiRunLM_Fitter(DW_Scheme scheme,
		...
		compNames[0] = new String("zeppelin");
		...
		initialParams[6] = 2E-10;// diffperp1
		initialParams[7] = 1.7E-9;//zeppelin diffusivity
		initialParams[8] = 1.570796326794897;//theta_zep
		initialParams[9] = 1.570796326794897;//phi_zep
		initialParams[10] = 1.0E-10;//diffperp
	...
	public static void main(String[] args) {
		...
		BiZeppelinMultiRunLM_Fitter inv = new BiZeppelinMultiRunLM_Fitter(
