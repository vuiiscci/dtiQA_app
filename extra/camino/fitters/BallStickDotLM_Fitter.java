 ...
 * <dt>Purpose:
 * 
 * <dd>Fits the ballstickdot model using one run of a Levenburg
 * Marquardt.
 * 
 * <dt>Description:
 * 
...
public class BallStickDotLM_Fitter extends CompartmentFitter {
	 ...
	 * @param scheme The imaging protocol.
	 */
	public BallStickDotLM_Fitter(DW_Scheme scheme, String[] compNames,
	 ...
	 * The volume fraction of the third compartment is calculated by (1-f1-f2) 
	 * where f1 is the volume fraction of the intracellular compartment and f2 
	...
	public static void main(String[] args) {
		...
		BallStickDotLM_Fitter inv = new BallStickDotLM_Fitter(
