 ...
 * <dt>Purpose:
 * 
 * <dd>Fits the zeppelincylinderdot model using one run of a Levenburg
 * Marquardt.
 * 
 * <dt>Description:
 * 
 * <dd> The diffusivity parameter is assumed the same in each compartment.
 * Parallel diffusivity, the unweighted signal and the radius are constrained
 * positive by optimizing their square root. Volume fraction is constrained to
 * [0 1] by optimizing cos^{-1} sqrt(f). Perpendicular diffusivity is
 * constrained to be lower than the parallel diffusivity by optimising
 * sin^(-1)sqrt(dperp/dparal).
 * 
 * </dl>
 * 
 ...
 * 
 */
public class ZeppelinCylinderDotLM_Fitter extends CompartmentFitter {
	 ...
	 */
	public ZeppelinCylinderDotLM_Fitter() {
	}
	 ...
	 */
	public ZeppelinCylinderDotLM_Fitter(DW_Scheme scheme) {
	...
	/**
	 * Estimates a starting set of parameters from the zeppelincylinderfitter.
	 * 
	 * @param data
	...
	public static void main(String[] args) {
		...
		ZeppelinCylinderDotLM_Fitter inv = new ZeppelinCylinderDotLM_Fitter(
