 ...
 * <dt>Purpose:
 * 
 * <dd>Fits the zeppelin and stick model using multiple runs of a Levenburg
 * Marquardt.
 * 
 * <dt>Description:
 * 
 * <dd> Fitting is as in ZeppelinStickLM_Fitter.  The
 ...
 *
 */
public class ZeppelinStickMultiRunLM_Fitter extends
	 ...
	 */
	public ZeppelinStickMultiRunLM_Fitter(DW_Scheme scheme,
		...
		initialParams[5] = 1.5;//phi
		initialParams[6] = 1.7E-9;//zeppelin diffusivity
		initialParams[7] = 1.570796326794897;//theta_zep
		initialParams[8] = 1.5;//phi_zep
		initialParams[9] = 2.0E-10;//diffperp
	...
	public static void main(String[] args) {
		...
		ZeppelinStickMultiRunLM_Fitter inv = new ZeppelinStickMultiRunLM_Fitter(
