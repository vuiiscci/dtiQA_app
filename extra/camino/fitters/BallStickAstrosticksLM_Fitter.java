 ...
 * <dt>Purpose:
 * 
 * <dd>Fits the ballstick and astrosticks model using one run of a Levenburg
 * Marquardt.
 * 
 * <dt>Description:
 * 
 * <dd> The diffusivity parameter is assumed the same in each
 * compartment.  Diffusivity and the unweighted signal are 
 * constrained positive by optimizing their square root.
 * Volume fractions of the intracellular and extracellular compartments are 
 ...
 *
 */
public class BallStickAstrosticksLM_Fitter extends CompartmentFitter {
	 ...
	 */
	public BallStickAstrosticksLM_Fitter() {
	}
	 ...
	 */
	public BallStickAstrosticksLM_Fitter(DW_Scheme scheme) {
	 ...
	 * @param scheme The imaging protocol.
	 */
	public BallStickAstrosticksLM_Fitter(DW_Scheme scheme, String[] compNames, double[] initialParams) {
	...
	protected void makeCodec() {
		cod = new Codec() {
			...
			public double[] optToModel(double[] optParams) {
				...
				modelParams[8] = modelParams[7]; //diff astrosticks
	...
	public static void main(String[] args) {
		...
		BallStickAstrosticksLM_Fitter inv = new BallStickAstrosticksLM_Fitter(
