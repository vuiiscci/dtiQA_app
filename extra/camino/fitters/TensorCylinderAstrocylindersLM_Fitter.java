 ...
 * <dt>Purpose:
 * 
 * <dd>Fits the tensorcylinderastrocylinders model using one run of a Levenburg
 * Marquardt.
 * 
 * <dt>Description:
 * 
 ...
 *
 */
public class TensorCylinderAstrocylindersLM_Fitter extends CompartmentFitter {
	 ...
	 */
	public TensorCylinderAstrocylindersLM_Fitter() {
	}
	 ...
	 */
	public TensorCylinderAstrocylindersLM_Fitter(DW_Scheme scheme) {
	...
	protected void makeCodec() {
		cod = new Codec() {
			...
			public double[] optToModel(double[] optParams) {
				...
				modelParams[15] = modelParams[7];//R
	...
	public static void main(String[] args) {
		...
		TensorCylinderAstrocylindersLM_Fitter inv = new TensorCylinderAstrocylindersLM_Fitter(
