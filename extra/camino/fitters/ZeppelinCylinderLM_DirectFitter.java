 ...
 *
 */
public class ZeppelinCylinderLM_DirectFitter extends CompartmentFitter {
	 ...
	 */
	public ZeppelinCylinderLM_DirectFitter() {
	}
	 ...
	 */
	public ZeppelinCylinderLM_DirectFitter(DW_Scheme scheme) {
	 ...
	 */
	public ZeppelinCylinderLM_DirectFitter(DW_Scheme scheme, String[] compNames,
		...
		cod = new Codec() {
			...
			public double[] modelToOpt(double[] modelParams) {
				...
				// smaller than parallel diffusivity.
                                optParams[6] = (Math.asin(Math.sqrt(modelParams[10] / modelParams[3])));
			...
			public double[] optToModel(double[] optParams) {
				...
				modelParams[3] = optParams[2] * optParams[2]; // cyl diff
				...
				modelParams[5] = optParams[4]; //phi
				    ...
				    * Math.sin(optParams[6]);// diff perp fraction of diff par
                                modelParams[10] = modelParams[10] * modelParams[3];// diff perp zep
		    ...
		    J.entries[6][5] = -2.0*maxR*Math.sin(optParams[5])*Math.cos(optParams[5]);
                    ...
                    J.entries[8][3] = 1.0;
                    J.entries[9][4] = 1.0;
		    J.entries[10][2] = 2.0*optParams[2]*Math.sin(optParams[6])*Math.sin(optParams[6]);
		    J.entries[10][6] = 2.0*optParams[2]*optParams[2]*Math.sin(optParams[6])*Math.cos(optParams[6]);
	...
	public static void main(String[] args) {
		...
		ZeppelinCylinderLM_DirectFitter inv = new ZeppelinCylinderLM_DirectFitter(CL_Initializer.imPars);
