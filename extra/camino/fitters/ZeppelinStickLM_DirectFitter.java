 ...
 * <dt>Purpose:
 * 
 * <dd>Fits the zeppelin and stick model using one run of a Levenburg
 ...
 *
 */
public class ZeppelinStickLM_DirectFitter extends CompartmentFitter {
	 ...
	 */
	public ZeppelinStickLM_DirectFitter(DW_Scheme scheme) {
	 ...
	 */
	public ZeppelinStickLM_DirectFitter(DW_Scheme scheme, String[] compNames,
		...
		cod = new Codec() {
			...
			public double[] modelToOpt(double[] modelParams) {
				...
				// smaller than parallel diffusivity.
                                optParams[5] = (Math.asin(Math.sqrt(modelParams[9] / modelParams[3])));
			...
			public double[] optToModel(double[] optParams) {
				...
				modelParams[5] = optParams[4]; //phi
				    ...
				    * Math.sin(optParams[5]);// diff perp fraction of diff par
                                modelParams[9] = modelParams[9] * modelParams[3];// diff perp zep
