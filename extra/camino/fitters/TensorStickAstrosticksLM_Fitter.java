 ...
 * <dt>Purpose:
 * 
 * <dd>Fits the tensorstick and astrosticks model using one run of a Levenburg
 * Marquardt.
 * 
 * <dt>Description:
 * 
 ...
 *
 */
public class TensorStickAstrosticksLM_Fitter extends CompartmentFitter {
	 ...
	 */
	public TensorStickAstrosticksLM_Fitter() {
	}
	 ...
	 */
	public TensorStickAstrosticksLM_Fitter(DW_Scheme scheme) {
	...
	public static void main(String[] args) {
		...
		TensorStickAstrosticksLM_Fitter inv = new TensorStickAstrosticksLM_Fitter(
