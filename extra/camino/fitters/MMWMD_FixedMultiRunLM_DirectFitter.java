 ...
 * <dt>Purpose:
 * 
 * <dd>Fits the MMWMD fixed tissue model using multiple runs of a
 * Levenburg Marquardt and a specified noise model.
 * 
 * <dt>Description:
 * 
 * <dd> Fitting is as in MMWMD_FixedLM_DirectFitter.  The
 ...
 *
 */
public class MMWMD_FixedMultiRunLM_DirectFitter extends MMWMD_FixedLM_DirectFitter {
     ...
     */
    public MMWMD_FixedMultiRunLM_DirectFitter(DW_Scheme scheme, int repeats, int seed) {
    ...
    public static void main(String[] args) {
        ...
        MMWMD_FixedMultiRunLM_DirectFitter inv = new MMWMD_FixedMultiRunLM_DirectFitter(CL_Initializer.imPars, 3, 0);
