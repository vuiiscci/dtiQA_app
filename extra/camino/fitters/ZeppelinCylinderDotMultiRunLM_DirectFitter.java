 ...
 * <dt>Purpose:
 * 
 * <dd>Fits the zeppelin-cylinder-dot model using multiple runs of a Levenburg
 * Marquardt and a specified noise model.
 * 
 * <dt>Description:
 * 
 * <dd> Fitting is as in ZeppelinCylinderDotLM_DirectFitter.  The
 ...
 *
 */
public class ZeppelinCylinderDotMultiRunLM_DirectFitter extends ZeppelinCylinderDotLM_DirectFitter {
     ...
     */
    public ZeppelinCylinderDotMultiRunLM_DirectFitter(DW_Scheme scheme, int repeats, int seed) {
    ...
    public static void main(String[] args) {
        ...
        ZeppelinCylinderDotMultiRunLM_DirectFitter inv = new ZeppelinCylinderDotMultiRunLM_DirectFitter(CL_Initializer.imPars, 3, 0);
