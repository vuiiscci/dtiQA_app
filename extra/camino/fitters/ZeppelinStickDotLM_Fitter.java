 ...
 * <dt>Purpose:
 * 
 * <dd>Fits the zeppelinstick  and dot model using one run of a Levenburg
 * Marquardt.
 * 
 * <dt>Description:
 * 
 ...
 *
 */
public class ZeppelinStickDotLM_Fitter extends CompartmentFitter {
	 ...
	 */
	public ZeppelinStickDotLM_Fitter() {
	}
	 ...
	 */
	public ZeppelinStickDotLM_Fitter(DW_Scheme scheme) {
	...
	public static void main(String[] args) {
		...
		ZeppelinStickDotLM_Fitter inv = new ZeppelinStickDotLM_Fitter(
