 ...
 * <dt>Purpose:
 * 
 * <dd>Fits the ballstick and astrocylinders model using one run of a Levenburg
 * Marquardt.
 * 
 * <dt>Description:
 * 
 ...
 *
 */
public class BallStickAstrocylindersLM_Fitter extends CompartmentFitter {
	 ...
	 */
	public BallStickAstrocylindersLM_Fitter() {
	}
	 ...
	 */
	public BallStickAstrocylindersLM_Fitter(DW_Scheme scheme) {
		...
		cod = new Codec() {
			...
			public double[] modelToOpt(double[] modelParams) {
				...
				optParams[6] = (Math.acos(Math
						.sqrt((modelParams[9] - 1e-7) / 20e-6)));// R
			...
			public double[] optToModel(double[] optParams) {
				...
				modelParams[8] = modelParams[7]; //diff astro
...
double bsaparams[];
	...
	public static void main(String[] args) {
		...
		BallStickAstrocylindersLM_Fitter inv = new BallStickAstrocylindersLM_Fitter(
